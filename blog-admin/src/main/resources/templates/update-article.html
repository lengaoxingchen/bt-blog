...
<head>
    ...
    <title>文章修改 - JsonLuBlog管理系统</title>
                ...
                <form action="/article/update" method="post" class="add-article-form">
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="article-title" name="title" class="form-control"
                                   placeholder="在此处输入标题" value="${article.title}" required autofocus
                                   autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" class="form-control" placeholder="请输入关键字"
                                       value="${article.keywords}" name="keywords" autocomplete="off">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <ul class="category-list">
                                    ...
                                    <li>
                                        <label>
                                            <input name="category" type="radio" value="${category.id}" <#if
                                            article.categoryId == category.id> checked</#if>>
                                        ${category.name} <em class="hidden-md">( 栏目ID: <span>${category.id}</span>
                                        )</em></label>
                                    </li>
                                </#list>
                                </ul>
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" class="form-control" placeholder="输入新标签" value="${article.tags}"
                                       name="tags"
                                       autocomplete="off">
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                <input type="text" class="form-control" placeholder="点击按钮选择图片" id="pictureUpload"
                                       name="titlePic" autocomplete="off" value="${article.titlePic}">
                            </div>
                        ...
                        <div class="add-article-box">
                            ...
                            <div class="add-article-box-content">
                                ...
                                <p><label>公开度：</label><input type="radio" name="visibility" value="0" <#if
                                    article.visibility ==0> checked</#if>/>公开 <input
                                    type="radio" name="visibility" value="1"<#if article.visibility ==1> checked
                            </#if> />加密</p>
...
<div id="rightClickMenu">
    <ul class="list-group rightClickMenuList">
        <li class="list-group-item disabled">欢迎访问JsonLuBlog</li>
