    ...
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
            <form action="#" method="post">
                ...
                <h1 class="page-header">管理 <span class="badge">${articleList.total}</span></h1>
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                        <#if (articleList.list??) && (articleList.list?size>0)>
                ...
                <footer class="message_footer">
                    <nav>
                        ...
                        <#if articleList.pages gt 1>
                            <ul class="pagination pagenav">
                                <li class="disabled">
                                    <#if articleList.hasPreviousPage == true>
                                        <a href="?pageNo=${articleList.prePage}" aria-label="Previous"> <span
                                                    aria-hidden="true">&laquo;</span></a>                            </#if>

                                </li>
                                <#list 1..articleList.pages as page>
                                    <li><a href="/article?pageNo=${page}">${page}</a></li>
                                </#list>

                                <li class="disabled">
                                    <#if articleList.hasNextPage  ==true>
                                        <a href="?pageNo=${articleList.nextPage}"
